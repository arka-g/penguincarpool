    ...
    public class JoinGetIO extends AsyncTask<Void, Void, String> {
      ...
      protected String getASCIIContentFromEntity(HttpEntity entity) throws IllegalStateException, IOException {
        ...
        protected String doInBackground(Void... params) {
            ...
            //get available taxis
            HttpGet httpGet = new HttpGet("http://192.168.1.118/penguin-carpool/public/carpool");
            String text = null;
            try {
        ...
        protected void onPostExecute(String results) {
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View viewClicked, int position, long id) {
                    ...
                    HttpPost httpPost = new HttpPost("http://192.168.1.118/penguin-carpool/public/messagePost");
                    //Post Data
