...
class LoginController extends BaseController{
	...
	public function showLogin(){
		if (Auth::check()){
			return Response::json(['status'=>200,Auth::user()->first_name, Auth::user()->last_name, Auth::user()->email, Auth::user()->id, Auth::user()->message, Auth::user()->rating, Auth::user()->message_result, Auth::user()->password]);
		}
		else{
