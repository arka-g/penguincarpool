...
public class LoginScreen extends Activity implements View.OnClickListener {
    ...
    public class LoginGetIO extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            HttpPost httpPost = new HttpPost("http://172.17.82.216/penguin-carpool/public/login");
...
//            HttpGet httpGet = new HttpGet("http://10.0.2.2/penguin-carpool/public/login");
            //for phone
            HttpGet httpGet = new HttpGet("http://172.17.82.216/penguin-carpool/public/login");
            String text = null;
