...
public class MessageScreen extends LoginScreen {
    ...
    public void onClick(View arg0) {
        ...
        if (arg0.equals(btnYes)) {
            ...
            // Display accept
            Toast toast = Toast.makeText(MessageScreen.this, "Carpool Accepted", Toast.LENGTH_LONG);
            ...
            // Display decline
            Toast toast = Toast.makeText(MessageScreen.this, "Carpool Declined", Toast.LENGTH_LONG);
            toast.setGravity(Gravity.TOP, 25, 400);
            toast.show();
        }
    }
