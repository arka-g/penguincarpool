...
public class ScheduleScreen extends LoginScreen {
    ...
    public class ScheduleGetIO extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            HttpPost httpPost = new HttpPost("http://172.17.81.172/penguin-carpool/public/saveschedule");
...
//                Log.d("Http Post Response:", nameValuePair.toString());
            ...
            HttpGet httpGet = new HttpGet("http://172.17.81.172/penguin-carpool/public/getschedule");
            String text = null;
            try {
